...
interface Props {
    ...
    isNothingFetched: boolean;
    onSelectArticle: (article: Article) => void
}

export const NewsFeed = ({ isLoading, articles, isNothingFetched, onSelectArticle}: Props) => {
    if (isLoading) {
    ...
    return (
        <div className="col-span-full mt-10 flex flex-col items-center justify-center gap-20">
            ...
            <div className="flex flex-col gap-2 text-center text-neutral-500">
                {isNothingFetched ? <strong className="text-4xl">Start searching for news!</strong> : (
                    <>
